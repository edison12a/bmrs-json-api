...
class DurableStompConnection:
    ...
    def __init__(self, api_key,
                 bmrs_message_processor, logger=CustomLogger(),  client_id=get_hostname(), message_types=[],
                 bmrs_host='api.bmreports.com', port=61613, durable=True,
                 poll_interval=1, xml_to_json=True):
        ...
        self.__connection = stomp.Connection12(host_and_ports=[
            (bmrs_host, port)], use_ssl=True)
    ...
    def __generate_jms_type_selector_string(self):
        ...
        """
        selector_substrings = ["JMSType='{}'".format(
            message_type) for message_type in self.__message_types]
    ...
    def __connect(self):
        ...
        """
        self.__connection.connect(self.__api_key, self.__api_key, wait=True,
